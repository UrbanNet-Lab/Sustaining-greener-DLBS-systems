...
alpha_gg=0.6
#ax1.scatter(x_bj,y_bj,label=r'bj_all',alpha=alpha_gg)
#ax1.scatter(x_bj1,y_bj1,label='bj_1',alpha=alpha_gg)
#ax1.scatter(x_bj2,y_bj2,label='bj_2',alpha=alpha_gg)
##popt, pcov = curve_fit(func2, x_sh[2:],y_sh[2:],maxfev = 10000)        #50-75
#popt, pcov = curve_fit(func2, x_sh[4:],y_sh[4:],maxfev = 10000)        #100_150
#y888 = [func2(i, *popt) for i in x_sh]
#ax1.scatter(x_sh,y_sh,label=r'sh_all, $\alpha$=%.2f'%popt[1],alpha=alpha_gg)
#ax1.plot(x_sh,y888,color='red',linewidth = 2,linestyle='-')
#ax1.scatter(x_sh1,y_sh1,label='sh_1',alpha=alpha_gg)
#ax1.scatter(x_sh2,y_sh2,label='sh_2',alpha=alpha_gg)
#ax1.scatter(x_sh3,y_sh3,label='sh_3',alpha=alpha_gg)
#ax1.scatter(x_sh4,y_sh4,label='sh_4',alpha=alpha_gg)
#ax1.legend(loc=3,handletextpad=0.1,prop={'size':18,'family':f_family})
#ax1.set_yscale('log')
#ax1.set_xscale('log')
#ax1.set_ylim([0.00000001,1])
#ax1.set_xlabel(r'rank(times$^{-1}$)',size=18,family=f_family)  
#ax1.set_ylabel(r'$P$(rank)',size=18,family=f_family)

    
ax2.scatter(m_bj,n_bj,label=r'bj_all',alpha=alpha_gg)
ax2.scatter(m_bj1,n_bj1,label='bj_1',alpha=alpha_gg)
ax2.scatter(m_bj2,n_bj2,label='bj_2',alpha=alpha_gg)
...
ax2.scatter(m_sh,n_sh,label=r'sh_all, $\alpha$=%.2f'%popt[1],alpha=alpha_gg)
ax2.plot(m_sh,y888,color='red',linewidth = 2,linestyle='-')
ax2.scatter(m_sh1,n_sh1,label='sh_1',alpha=alpha_gg)
ax2.scatter(m_sh2,n_sh2,label='sh_2',alpha=alpha_gg)
ax2.scatter(m_sh3,n_sh3,label='sh_3',alpha=alpha_gg)
ax2.scatter(m_sh4,n_sh4,label='sh_4',alpha=alpha_gg)
