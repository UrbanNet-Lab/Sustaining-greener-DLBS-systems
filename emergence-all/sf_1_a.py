#距离分布，百米为单位，方式有起止点的轨迹距离，导航距离，直线距离
import numpy as np
...
#ax.scatter(x_sh,y_sh,label=r'sh, $\alpha$=%.2f'%popt[1])
#ax.plot(x_sh,y777,'b-')
...
#ax.scatter(x_bj,y_bj,label=r'bj, $\alpha$=%.2f'%popt[1])
#ax.plot(x_bj,y888,color='orange',linestyle='-')
#ax.scatter(x_nj2,y_nj2,label=r'nj (DiDi)')
##ax.scatter(x_nj,y_nj,label=r'nj (Mobike)')
...
#距离度量
#ax.plot(x_sh_eu,y_sh_eu,marker='s',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Euclidean)')
#ax.plot(x_bj_eu,y_bj_eu,marker='s',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D2 (Euclidean)')
#ax.plot(x_sh_ro,y_sh_ro,marker='^',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Routing)')
#ax.plot(x_bj,y_bj,marker='^',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D2 (Routing)')
#ax.plot(x_sh,y_sh,marker='o',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Trajectory)')
data1=pd.read_csv('C:/python/摩拜单车/距离/dis_sh.txt')
data2=pd.read_csv('C:/python/摩拜单车/距离/dis_bj.txt')
data3=pd.read_csv('C:/python/摩拜单车/距离/dis_sh_eu.txt')
data4=pd.read_csv('C:/python/摩拜单车/距离/dis_bj_eu.txt')
data5=pd.read_csv('C:/python/摩拜单车/距离/dis_sh_ro.txt')
x_sh,y_sh=data1['x'],data1['y']
x_bj,y_bj=data2['x'],data2['y']
x_sh_eu,y_sh_eu=data3['x'],data3['y']
x_bj_eu,y_bj_eu=data4['x'],data4['y']
x_sh_ro,y_sh_ro=data5['x'],data5['y']
x_sh,y_sh=log_pdf(x_sh[:],y_sh[:],0,3,35)
x_bj,y_bj=log_pdf(x_bj[:],y_bj[:],0,3,30)  
x_sh_eu,y_sh_eu=log_pdf(x_sh_eu[:],y_sh_eu[:],0,3,35)
x_bj_eu,y_bj_eu=log_pdf(x_bj_eu[:],y_bj_eu[:],0,3,30) 
x_sh_ro,y_sh_ro=log_pdf(x_sh_ro[:],y_sh_ro[:],0,3,35)
ax.plot(x_sh_eu,y_sh_eu,marker='s',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Euclidean)')
ax.plot(x_bj_eu,y_bj_eu,marker='s',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D2 (Euclidean)')
ax.plot(x_sh_ro[:-1],y_sh_ro[:-1],color='#1f77b4',marker='^',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Routing)')
ax.plot(x_bj,y_bj,marker='^',color='#ff7f0e',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D2 (Routing)')
ax.plot(x_sh,y_sh,marker='o',color='#1f77b4',markersize=10,markerfacecolor='none',markeredgewidth=2,linewidth=0,label=r'D1 (Trajectory)')
...
#logbin
#x_sh_log,y_sh_log=log_pdf(x_sh,y_sh,-1,2)
#x_bj_log,y_bj_log=log_pdf(x_bj,y_bj,-1,2)
#x_nj_log,y_nj_log=log_pdf(x_nj,y_nj,-1,2)
#x_nj2_log,y_nj2_log=log_pdf(x_nj2,y_nj2,-1,2)
#popt, pcov = curve_fit(func2, x_sh[4:],y_sh[4:],maxfev = 10000)
#y777 = [func2(i, *popt) for i in x_sh_log]
#ax.scatter(x_sh_log,y_sh_log,label=r'sh, $\alpha$=%.2f'%popt[1])
#ax.plot(x_sh_log,y777,'b-')
#popt, pcov = curve_fit(func2, x_bj[1:],y_bj[1:],maxfev = 10000)
#y888 = [func2(i, *popt) for i in x_bj_log]
#ax.scatter(x_bj_log,y_bj_log,label=r'bj, $\alpha$=%.2f'%popt[1])
#ax.plot(x_bj_log,y888,color='orange',linestyle='-')
#ax.scatter(x_sh_log,y_sh_log,label=r'sh (Mobike)')
#ax.scatter(x_bj_log,y_bj_log,label=r'bj (Mobike)')
#ax.scatter(x_nj_log,y_nj_log,label=r'nj (Mobike)')
#ax.scatter(x_nj2_log,y_nj2_log,label=r'nj (DiDi)')
...
#plt.savefig('C:/python/摩拜单车/draw2/sf_1_a.pdf',bbox_inches='tight')
