...
ax11.plot(m_sh2[2:],n_sh2[2:],alpha=alpha_xy,marker='o',linestyle='--',label='D1 (r=100)')
ax11.plot(m_sh3[3:],n_sh3[3:],alpha=alpha_xy,marker='o',linestyle='--',label='D1 (r=200)')
ax11.plot(m_sh4[4:],n_sh4[4:],alpha=alpha_xy,marker='o',linestyle='--',label='D1 (r=300)')
ax11.plot(m_sh5[4:],n_sh5[4:],alpha=alpha_xy,marker='o',linestyle='--',label='D1 (r=400)')
ax11.plot(m_sh6[5:],n_sh6[5:],alpha=alpha_xy,marker='o',linestyle='--',label='D1 (r=500)')
...
#plt.savefig('C:/python/摩拜单车/draw2/sf_8_sh.pdf',bbox_inches='tight')
