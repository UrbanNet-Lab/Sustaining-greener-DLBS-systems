...
ax111.set_xticklabels([int(i) for i in ax111.get_xticks()],family=f_family,size=18)
...
ax111.legend(loc=1,handletextpad=0.1,ncol=2,columnspacing=1,prop={'size':18,'family':f_family})
ax111.set_xlabel('#bikes',size=18,family=f_family)  
ax111.set_ylabel('$P$(#)',size=18,family=f_family)
#plt.savefig('C:/python/摩拜单车/draw2/sf_7_a.pdf',bbox_inches='tight')       
