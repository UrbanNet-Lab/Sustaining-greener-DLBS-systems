...
data=pd.read_csv('C:/python/Mobai/Xian/bikes_group_combine2.txt')
...
alpha_xy=1
ax11.plot(m_bj1,n_bj1,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=50)')
#ax11.plot(m_bj2,n_bj2,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=100)')
#ax11.plot(m_bj3,n_bj3,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=150)')
#ax11.plot(m_bj4,n_bj4,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=200)')
#ax11.plot(m_bj5,n_bj5,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=250)')
#ax11.plot(m_bj6,n_bj6,alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=300)')
ax11.plot(m_bj2[1:],n_bj2[1:],alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=100)')
ax11.plot(m_bj3[2:],n_bj3[2:],alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=150)')
ax11.plot(m_bj4[2:],n_bj4[2:],alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=200)')
ax11.plot(m_bj5[3:],n_bj5[3:],alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=250)')
ax11.plot(m_bj6[3:],n_bj6[3:],alpha=alpha_xy,marker='o',linestyle='--',label='D6 (r=300)')
...
#plt.savefig('C:/python/摩拜单车/draw2/sf_8_xa.pdf',bbox_inches='tight')
