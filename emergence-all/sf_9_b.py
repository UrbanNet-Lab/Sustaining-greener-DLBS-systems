...
#deadline1=pd.datetime(2017, 5, 10, 0, 0)   #星期三
#deadline2=pd.datetime(2017, 5, 11, 0, 0)
...
#data_ha=data_new[['orderid','userid','bikeid','biketype','starttime','endtime','start_x','start_y','end_x','end_y','t(s)','d(m)']]
#data_ha.to_csv('C:/python/MOBIKE_CUP_2017/Mobike_bj_day1.csv',index=False)


nodes=10


#data=pd.read_csv('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_200.csv') 
#rows=data.index
#rank_all=[]
#for row in rows:
...
#    degree[i[0]][i[1]]=j
#np.savetxt('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_degree_%d_200.txt'%nodes,degree,fmt='%d',delimiter=',')
...
degree_bj=np.loadtxt('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_degree_%d.txt'%nodes,dtype=int,delimiter=',')
degree_no=[]
degree_no_index=[]
degree_no_se=[]
for i in range(nodes):
...
plt.axis('off')
#plt.savefig('C:/python/摩拜单车/draw2/dyn_b.pdf',bbox_inches='tight') 
...
#
#degree_bj=np.loadtxt('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_degree_%d.txt'%nodes,dtype=int,delimiter=',')
##degree_bj=np.loadtxt('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_degree_%d_200.txt'%nodes,dtype=int,delimiter=',')
#degree_no=[]
#degree_no_se=[]
#for i in range(nodes):
#    for j in range(nodes):
...
#data=pd.read_csv('C:/python/MOBIKE_CUP_2017/Mobike_bj_day1.csv') 
#rows=data.index
#
#DR1=0.002                                        
#bike_all=[]
...
#data_new.to_csv('C:/python/MOBIKE_CUP_2017/dyn/dyn_bj_200.csv',index=False)
