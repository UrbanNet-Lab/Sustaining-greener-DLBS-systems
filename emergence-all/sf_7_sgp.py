...
data=pd.read_csv('C:/python/Singapore/bikes_group_combine.txt')
...
alpha_xy=1
ax11.plot(m_bj1,n_bj1,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=50)')
#ax11.plot(m_bj2,n_bj2,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=100)')
#ax11.plot(m_bj3,n_bj3,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=150)')
#ax11.plot(m_bj4,n_bj4,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=200)')
#ax11.plot(m_bj5,n_bj5,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=250)')
#ax11.plot(m_bj6,n_bj6,alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=300)')
ax11.plot(m_bj2[1:],n_bj2[1:],alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=100)')
ax11.plot(m_bj3[2:],n_bj3[2:],alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=150)')
ax11.plot(m_bj4[3:],n_bj4[3:],alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=200)')
ax11.plot(m_bj5[3:],n_bj5[3:],alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=250)')
ax11.plot(m_bj6[4:],n_bj6[4:],alpha=alpha_xy,marker='o',linestyle='--',label='D8 (r=300)')
...
#plt.savefig('C:/python/摩拜单车/draw2/sf_8_sgp.pdf',bbox_inches='tight')
