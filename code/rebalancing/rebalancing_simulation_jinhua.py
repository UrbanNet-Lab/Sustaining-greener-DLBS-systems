...
df[df['count']>1].groupby('t')['count'].sum().sort_values()
df.to_csv('jinhua.csv',index=False)
...
t_272= df[df['t']==248]
t_272.to_csv('jh_248.csv',index=False)
...
select_df.to_csv('jh_sim.csv',index=False)
