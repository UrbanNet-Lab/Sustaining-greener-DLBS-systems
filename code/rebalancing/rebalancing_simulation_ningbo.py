...
df.to_csv('ningbo.csv',index=False)


# In[78]:


a = df[df['count']>1].groupby('t')['count'].sum()
a[a<2000].sort_values(ascending=False)

# a[a<1000].sort_values()

# t_275 = df[df['t']==275]
# t_275.to_csv('nb_275.csv',index=False)


# In[86]:


t_247 = df[df['t'] == 18+ 7 * 24]
# t_247.to_csv('nb_247.csv',index=False)
t_247['count'].sum()
...
select_df.to_csv('nb_sim.csv',index=False)
